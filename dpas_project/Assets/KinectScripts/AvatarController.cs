...
//				case KinectWrapper.SkeletonJoint.LEFT_WRIST:
//					return (int)KinectWrapper.SkeletonJoint.RIGHT_WRIST;
...
//				case KinectWrapper.SkeletonJoint.RIGHT_WRIST:
//					return (int)KinectWrapper.SkeletonJoint.LEFT_WRIST;
...
//				case KinectWrapper.SkeletonJoint.LEFT_ANKLE:
//					return (int)KinectWrapper.SkeletonJoint.RIGHT_ANKLE;
...
//				case KinectWrapper.SkeletonJoint.RIGHT_ANKLE:
//					return (int)KinectWrapper.SkeletonJoint.LEFT_ANKLE;
	...
	void MapBones()
	{
		...
		if(LeftToes != null && (int)KinectWrapper.SkeletonJoint.LEFT_FOOT >= 0)
			bones[(int)KinectWrapper.SkeletonJoint.LEFT_FOOT] = LeftToes;
		...
		if(RightToes!= null && (int)KinectWrapper.SkeletonJoint.RIGHT_FOOT >= 0)
			bones[(int)KinectWrapper.SkeletonJoint.RIGHT_FOOT] = RightToes;
	}
